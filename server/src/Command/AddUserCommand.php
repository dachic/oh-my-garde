...
class AddUserCommand extends Command
{
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->io->text([
            ...
            '',
            ' $ php bin/console app:user:add password email@example.com',
            '',
        ...
        if (null !== $password) {
            $this->io->text(' > <info>Password</info>: ' . strlen($password));
        } else {
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $region = $this->entityManager->getRepository(Region::class)->find(1);
        ...
        $user->setFirstname('F');
        $user->setLastname('L');
        $user->setPhoneNumber('+3300000000000');
